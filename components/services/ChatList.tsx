...
const ChatList =(props: { services: { names: any; id:any;profile:any }; }) => {
    const {id,names,profile} = props.services;
        ...
        <TouchableWithoutFeedback onPress={goToChat}>
                            <View style={styles.service}>
                                {/* <Image
                                    ...
                                    source={{uri: 'http://soft.com:8080/assets/profile/'+profile}}
                                    /> */}
                                    <Image
                                    style={styles.serviceImg}
                                    source={{uri: 'https://skolpulse.rw/api/soft/assets/profile/'+profile}}
                                    />
                                    <View style={styles.serviceBody}>
                                        <Text style={styles.serviceTitle}>{names}</Text>
